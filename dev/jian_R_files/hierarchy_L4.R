...
saveRDS(pw_naive_sil_L4, "pw_naive_sil_L4.rds")
...
saveRDS(mc_naive_sil_L4, "mc_naive_sil_L4.rds")
...
mc_markers_L4 <- contrast_MC_L4 %>%
  filter(level_3 != "dendritic_myeloid") %>% 
  single_marker_pw_select(LEVEL, .discard_num = 1000, METHOD)

saveRDS(mc_markers_L4, "mc_markers_L4.rds")

# pw_markers_L4 trend plots & PCA ==================
...
pw_markers_L4 %>% 
  ...
  geom_point() +
  theme_bw() +
  ggtitle("macrophage, 39 marker selected")
...
pw_markers_L4 %>% 
  ...
  stat_ellipse(type = 't')+
  theme_bw() +
  ggtitle("PCA macrophage, 39 markers selected, silhouette = 0.893")
...
pw_markers_L4 %>% 
  ...
  geom_point() +
  theme_bw() +
  ggtitle("t_CD8, 72 marker selected")
...
pw_markers_L4 %>% 
  ...
  stat_ellipse(type = 't')+
  theme_bw() +
  ggtitle("PCA t_CD8, 72 markers selected, silhouette = 0.831")

# trend plot nk_primed
pw_markers_L4 %>% 
  ...
  geom_point() +
  theme_bw() +
  ggtitle("nk_primed, 36 marker selected")
...
pw_markers_L4 %>% 
  ...
  stat_ellipse(type = 't')+
  theme_bw() +
  ggtitle("PCA nk_primed, 36 markers selected, silhouette = 0.714")

# pw_markers_L4.2 (base markers = 2) =================
# data output from new method

pw_markers_L4.2 <- contrast_PW_L4 %>%
  filter(level_3 != "dendritic_myeloid") %>% 
  single_marker_pw_select(LEVEL, .discard_num = 1000, METHOD)

saveRDS(pw_markers_L4.2, "pw_markers_L4.2.rds")

# pw_markers_L4.2 trend plots & PCA ==================
...
pw_markers_L4.2 %>% 
  ...
  geom_point() +
  theme_bw() +
  ggtitle("t_CD4, 6 marker selected")
...
pw_markers_L4.2 %>% 
  ...
  stat_ellipse(type = 't')+
  theme_bw() +
  ggtitle("PCA t_CD4, 6 markers selected, silhouette = 0.946")
...
pw_markers_L4.2 %>% 
  ...
  geom_point() +
  theme_bw() +
  ggtitle("macrophage, 41 marker selected")
...
pw_markers_L4.2 %>% 
  ...
  stat_ellipse(type = 't')+
  theme_bw() +
  ggtitle("PCA macrophage, 41 markers selected, silhouette = 0.876")
...
pw_markers_L4.2 %>% 
  ...
  geom_point() +
  theme_bw() +
  ggtitle("t_CD8, 75 marker selected")
...
pw_markers_L4.2 %>% 
  ...
  stat_ellipse(type = 't')+
  theme_bw() +
  ggtitle("PCA t_CD8, 75 markers selected, silhouette = 0.823")
...
pw_markers_L4.2 %>% 
  ...
  geom_point() +
  theme_bw() +
  ggtitle("nk_primed, 53 marker selected")
...
pw_markers_L4.2 %>% 
  ...
  stat_ellipse(type = 't')+
  theme_bw() +
  ggtitle("PCA nk_primed, 53 markers selected, silhouette = 0.721")
