# The results may take a few hours to produce so you do not necessarily need to run my example code
...
jian_example_output = 
  ...
  counts_tree_to_gene_markers(
    ...
    # I set the default value for k to be 60 which means 
