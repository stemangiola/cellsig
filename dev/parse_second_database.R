...
# RAW FILES WERE LOST SO THE WHOLE DATABASE 2 WAS SAVED IN THE DIRECTORY database

jian_t_dc_macro <- readRDS("/stornext/Bioinf/data/bioinf-data/Papenfuss_lab/projects/mangiola.s/PostDoc/cellsig/dev/database/jian_t_dc_macro/jian_t_dc_macro.rds")

jian_t_dc_macro %>% saveRDS("dev/counts_second_db_raw.rds")
