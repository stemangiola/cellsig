...
.bayes  =
  if(bayes==1L){
    readRDS("/stornext/Home/data/allstaff/w/wu.j/Master_Project/cellsig/dev/intermediate_data/counts_bayes_imputed_hierarchy.rds")
  } else {NULL}


readRDS("/stornext/Home/data/allstaff/w/wu.j/Master_Project/cellsig/dev/intermediate_data/counts_imputed_hierarchy.rds") %>% 
